...
function goback(){
    document.getElementById('content-container').innerHTML=previousContent[previousContent.length-1];
    previousContent.pop();
}
var previousContent=[];
function detail(id) {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            // console.log(data);
    html += `<div class="single_country">           
                <div class="detail-flag align-self-center justify-content-center">
                    <img src="${data.flags.png}">
                </div>
                <div class="detail-info mt-5">
                ...
                <div class="border_countries"><strong>Border Countries: </strong>${bordersdiv}</div>
            </div>
